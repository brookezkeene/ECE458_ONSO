...
namespace Web.Api.Infrastructure.Migrations.ApplicationDb
{
    ...
    [Migration("20200326234516_SymmetricPowerConnections")]
    partial class SymmetricPowerConnections
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Api.Infrastructure.Entities.AssetPowerPort", b =>
                {
                    ...
                    b.Property<Guid?>("PowerConnectionId1")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("AssetId");

                    b.HasIndex("PowerConnectionId1");
            ...
            modelBuilder.Entity("Web.Api.Infrastructure.Entities.PduPort", b =>
                {
                    ...
                    b.Property<Guid?>("PowerConnectionId1")
                        .HasColumnName("PduPort_PowerConnectionId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Web.Api.Infrastructure.Entities.PowerPort", b =>
                {
                    b.HasOne("Web.Api.Infrastructure.Entities.PowerConnection", null)
                        .WithMany("Ports")
            ...
            modelBuilder.Entity("Web.Api.Infrastructure.Entities.AssetPowerPort", b =>
                {
                    ...
                    b.HasOne("Web.Api.Infrastructure.Entities.PowerConnection", "PowerConnection")
                        .WithMany()
                        .HasForeignKey("PowerConnectionId1");
                });
